...
#define LOG(s) __android_log_print(ANDROID_LOG_DEBUG, "OnexApp", s);
#define LOG2(s,t) __android_log_print(ANDROID_LOG_DEBUG, "OnexApp", s,t);
#else
#define LOG(s) printf(s)
#define LOG2(s,t) printf(s,t)
#define LOG_ printf("%s:%d\n", __FILE__, __LINE__);
#endif
