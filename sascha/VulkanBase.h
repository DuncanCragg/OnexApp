...
//
  ...
  */
  ...
  virtual void keyPressed(uint32_t, uint32_t keysym);
  virtual void keyReleased(uint32_t, uint32_t keysym);
  ...
  void basePipelines(VkPipelineLayout& pipelineLayout,
                     size_t vertSize,
                     size_t instSize,
  ...
  void setupDescriptorPool(VkDescriptorPool* pDescriptorPool, size_t n);
